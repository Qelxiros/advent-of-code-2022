...
public class day17_2 {
    ...
    public static long prevHighestRock = 0;
    public static int prevI = 0;
...
//            System.out.println(highestRock);
        ...
        System.out.println((1000000000000L-5168)/1725);
        System.out.println((1000000000000L-5168)%1725);
        System.out.println(highestRock + 2728L*579710141);
    }
        ...
        while (true) {
            ...
            if (downNext) {
                ...
                if (index >= input.length()) {
                    if (highestRock-prevHighestRock==diff) {
                        System.out.println(index);
                        System.out.println(i);
                        System.out.println(highestRock);
                        System.out.println(diff);
                        System.out.println(prevHighestRock);
                    }
                    diff = highestRock-prevHighestRock;
                    iDiff = i - prevI;
                    prevI = i;
